// Configuration for Threadr frontend - SECURE VERSION
const config = {
    ...
    // SECURITY FIX: API keys completely removed from frontend for security
    ...
    // Deploy timestamp: 2025-08-04T08:20:00Z
...
if (config.FEATURES.DEBUG_MODE) {
    console.log('Threadr Config (SECURE):', config);
...
if (!config.FEATURES.DEBUG_MODE && window.location.hostname.includes('vercel')) {
    ...
    console.log('Production Debug - Secure config loaded successfully');
}